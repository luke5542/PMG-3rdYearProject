...
Image generatePerlin(MapGenConfig config)
{
    return generatePerlin("", false, config);
}

Image generatePerlin(string outputFile, MapGenConfig config)
{
    return generatePerlin(outputFile, true, config);
}

Image generatePerlin(string outputFile, bool saveImage, MapGenConfig config)
{
...
{
    return generatePerlin(outputFile, true, size, threshold, use3DNoise, smoothEdges);
}

Image generatePerlin(string outputFile, bool saveImage, int size, uint threshold, bool use3DNoise, uint smoothEdges)
{
